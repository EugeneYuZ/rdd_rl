...
from scoop_discrete_env_lr import ScoopEnv


class ConvDQN(torch.nn.Module):
    def __init__(self):
        super(ConvDQN, self).__init__()
        self.conv1 = nn.Conv1d(5, 16, 5)
        self.conv2 = nn.Conv1d(16, 32, 3)
        self.fc1 = nn.Linear(458, 128)
...
class ConvDQNAgent(DQNAgent):
    def __init__(self, model_class, model=None, env=None, exploration=None,
        ...
        saving_dir = '/home/ur5/thesis/rdd_rl/scoop_discrete/data/dqn_lr'
