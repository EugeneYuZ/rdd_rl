...
class ScoopEnv:
    ...
    def step(self, a):
        ...
        target_pose = transformations.euler_matrix(self.target_orientation[0], self.target_orientation[1],
        ...
        if target_position[1] < 0.42 or target_position[1] > 0.95 or target_position[2] < 0 or target_position[2] > 0.3:
