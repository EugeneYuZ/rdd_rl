...
class Agent(SynDQNAgent):
    def __init__(self, model, envs, exploration,
                 ...
                 min_mem=1000):
        saving_dir = '/home/ur5/thesis/rdd_rl/scoop_3d/data/syn_dqn_stack'
...
if __name__ == '__main__':
    ...
    agent = Agent(DQN(envs[0].observation_space[0].shape, envs[0].observation_space[1].shape, envs[1].nA),
                  envs, LinearSchedule(100000, 0.1), batch_size=128, min_mem=200, memory_size=50000)
